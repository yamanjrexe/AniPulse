                ...
                <div className="container hero-content">
                    <div className="hero-text">
                        ...
                        <p className="hero-subtitle">
                            AniPulse is more than an anime tracker. Track every
                            episode, analyze habits, discover patterns, and
                        ...
                        <div className="hero-buttons">
                            ...
                            <button
                                ...
                                onClick={() => scrollTo(featuresRef)}
                            >
                                <i className="fas fa-chart-line" /> Explore
                                features
                            </button>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="section-header">
                        ...
                        <p className="section-subtitle">
                            Tracking, analytics, and community features combined
                            for anime lovers.
                        </p>
                    </div>
            ...
            <section id="stats" className="stats-section" ref={statsRef}>
                <div className="container">
                    <div className="section-header">
                        ...
                        <h2 className="section-title">
                            Trusted by anime enthusiasts
                        </h2>
                        <p className="section-subtitle">
                            Join thousands who transformed their tracking
                            experience.
                        </p>
                    </div>
                ...
                <div className="container">
                    <div className="cta-card">
                        ...
                        <p className="cta-subtitle">
                            Join AniPulse today and start tracking, analyzing,
                            and celebrating your anime journey.
                        </p>
                        ...
                        <div className="cta-buttons">
                            <button
                                ...
                                onClick={() => navigate("/login?register=true")}
                            >
                                <i className="fas fa-user-plus" /> Create free
                                account
                            </button>
                            <button
                                className="btn-secondary"
                            ...
                            >
                                <i className="fas fa-sign-in-alt" /> Sign in to
                                dashboard
                            </button>
                        </div>
                    </div>
            ...
            <footer className="footer">
                <div className="container">
                    ...
                    <div className="footer-bottom">
                        <p>
                            &copy; 2026 AniPulse. All rights reserved. Anime
                            data via Jikan API — fan-made project.
                        </p>
                    </div>
                </div>
            </footer>
